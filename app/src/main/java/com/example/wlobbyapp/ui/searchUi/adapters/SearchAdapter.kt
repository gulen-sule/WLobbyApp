package com.example.wlobbyapp.ui.searchUi.adapters
...
class SearchAdapter(
    diffCallback: DiffUtil.ItemCallback<MultiSearchResults>, val onClickImage: (MultiSearchResults?) -> Unit,
    val onClickButton: (MultiSearchResults) -> Unit
) :
    PagingDataAdapter<MultiSearchResults, SearchAdapter.ViewHolder>(diffCallback) {
